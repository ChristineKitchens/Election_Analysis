...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_options:
        ...
        county_summary = f"{county_name}: {county_vote_percentage:.1f}% ({county_vote:,})\n"
        ...
        if (county_vote > county_top_turnout) and (county_vote_percentage > county_winning_percentage):
            county_top_turnout = county_vote
